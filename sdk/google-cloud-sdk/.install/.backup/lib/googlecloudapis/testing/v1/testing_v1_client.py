...
class TestingV1(base_api.BaseApiClient):
  ...
  class ProjectsDevicesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Keepalive': base_api.ApiMethodInfo(
              ...
              path_params=[u'deviceId', u'projectId'],
              query_params=[],
              relative_path=u'projects/{projectId}/devices/{deviceId}/keepalive',
              request_field='',
    ...
    def Keepalive(self, request, global_params=None):
      """Issues a keep-alive to a GCE Android device instance. May return any of the following canonical error codes: - PERMISSION_DENIED - if the user is not authorized to read project - INVALID_ARGUMENT - if the request is malformed - NOT_FOUND - if the project does not exist.
  ...
  class ProjectsTestMatricesService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      """Request to run a matrix of tests according to the given specifications. Unsupported environments will be returned in the state UNSUPPORTED. May return any of the following canonical error codes: - PERMISSION_DENIED - if the user is not authorized to write to project - INVALID_ARGUMENT - if the request is malformed.
    ...
    def List(self, request, global_params=None):
      """List test matrices. The matrices are returned in the order of newest first by submit time. May return any of the following canonical error codes: - PERMISSION_DENIED - if the user is not authorized to read project - INVALID_ARGUMENT - if the request is malformed.
