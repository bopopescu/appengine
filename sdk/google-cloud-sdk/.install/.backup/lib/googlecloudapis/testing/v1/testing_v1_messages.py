...
class CancelTestExecutionResponse(messages.Message):
  ...
  class TestStateValueValuesEnum(messages.Enum):
    ...
    Values:
      ...
      INCOMPATIBLE_ENVIRONMENT: <no description>
    ...
    ERROR = 1
    FINISHED = 2
    INCOMPATIBLE_ENVIRONMENT = 3
    INVALID = 4
    IN_PROGRESS = 5
    PENDING = 6
    QUEUED = 7
    RUNNING = 8
    UNSPECIFIED_TEST_STATE = 9
    UNSUPPORTED_ENVIRONMENT = 10
    VALIDATING = 11
...
class TestDetails(messages.Message):
  ...
  Fields:
    ...
    progressDetails: A string attribute.
    progressMessages: A string attribute.
  """

  errorDetails = messages.StringField(1)
  errorMessage = messages.StringField(2)
  progressDetails = messages.StringField(3)
  progressMessages = messages.StringField(4, repeated=True)
