...
class Retryer(object):
  ...
  def __init__(self, max_retrials=None, max_wait_ms=None,
               exponential_sleep_multiplier=None, jitter_ms=1000,
  ...
  def RetryOnException(self, func, args, should_retry_if=None, sleep_ms=None):
  ...
  def RetryOnResult(self, func, args, should_retry_if=None, sleep_ms=None):
