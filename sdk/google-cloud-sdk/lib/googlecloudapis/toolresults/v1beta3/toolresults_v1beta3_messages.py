...
class FailureDetail(messages.Message):
  ...
  timedOut = messages.BooleanField(2)
...
class ProjectSettings(messages.Message):
  ...
  defaultBucket = messages.StringField(1)
...
class Step(messages.Message):
  ...
  Fields:
    ...
    dimensionValue: If the execution containing this step has any
      ...
      and dimension_value.  A PRECONDITION_FAILED will be returned if
...
class ToolresultsProjectsGetSettingsRequest(messages.Message):
...
class ToolresultsProjectsInitializeSettingsRequest(messages.Message):
